...
const FrontendProjComponents = ({i, title, description, image, githubLink, liveLink, className}) => {
  ...
  return (
    ...
    >
    <div className="flex justify-center items-center md:w-1/3 w-full md:h-[400px] h-[200px] overflow-hidden "><img src={`${process.env.PUBLIC_URL}/${image}`} className={`md:transform md:scale-[140%] md:hover:scale-110 md:duration-300 object-cover w-full h-full md:w-auto md:h-auto`}
    ></img></div>
